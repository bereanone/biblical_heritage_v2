...
class LibraryRootService {
  ...
  /// Looks up an asset only inside the selected Library Root.
  ///
  /// A library root is a provenance boundary.  Falling back to a legacy
  /// Documents folder makes the same catalog row resolve to different source
  /// editions depending on which old files happen to be present.  Missing
  /// files must therefore remain missing until they are explicitly restored
  /// or imported into the selected root.
